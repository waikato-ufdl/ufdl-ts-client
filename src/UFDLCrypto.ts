...
const UFDL_CRYPTO_SALT = _UFDLCrypto.encodeString("_UFDL_crypto_salt_");

const UFDLCrypto = crypto.subtle === undefined ? undefined : _UFDLCrypto;

export default UFDLCrypto;
