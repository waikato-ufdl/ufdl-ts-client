...
import {SPECTRUM_CLASSIFICATION_DATASETS_URL} from "../../constants";
...
export async function list(
    ...
    return base_actions.list(context, SPECTRUM_CLASSIFICATION_DATASETS_URL, filterSpec);
}
...
export async function retrieve(
    ...
    return await base_actions.retrieve(context, SPECTRUM_CLASSIFICATION_DATASETS_URL, pk);
}
...
export async function destroy(
    ...
    await base_actions.destroy(context, SPECTRUM_CLASSIFICATION_DATASETS_URL, pk);
}
...
export async function download(
    ...
    return await core_mixin_actions.download(context, SPECTRUM_CLASSIFICATION_DATASETS_URL, pk, filetype);
}
...
export async function add_file(
    ...
    return await core_mixin_actions.add_file(context, SPECTRUM_CLASSIFICATION_DATASETS_URL, pk, filename, data);
}
...
export async function add_files(
    ...
    return await core_mixin_actions.add_files(context, SPECTRUM_CLASSIFICATION_DATASETS_URL, pk, files);
}
...
export async function get_file(
    ...
    return await core_mixin_actions.get_file(context, SPECTRUM_CLASSIFICATION_DATASETS_URL, pk, filename);
}
...
export async function delete_file(
    ...
    return await core_mixin_actions.delete_file(context, SPECTRUM_CLASSIFICATION_DATASETS_URL, pk, filename);
}
...
export async function get_file_by_handle(
    ...
    return await core_mixin_actions.get_file_by_handle(context, SPECTRUM_CLASSIFICATION_DATASETS_URL, pk, handle);
}
...
export async function copy(
    ...
    return await core_mixin_actions.copy(context, SPECTRUM_CLASSIFICATION_DATASETS_URL, pk, {new_name: new_name, only_files: only_files});
}
...
export async function merge(
    ...
    return core_mixin_actions.merge(context, SPECTRUM_CLASSIFICATION_DATASETS_URL, pk, sourcePK, delete_, hard);
}
